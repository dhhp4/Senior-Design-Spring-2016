...
import retrofit2.RequestBuilderAction.*;
...
final class RequestFactoryParser {
  ...
  private Set<String> relativeUrlParamNames;
    private Object RequestBuilderAction;
  ...
  private RequestFactory toRequestFactory(BaseUrl baseUrl) {
    return new RequestFactory(httpMethod, baseUrl, relativeUrl, headers, contentType, hasBody, isFormEncoded, isMultipart, requestBuilderActions);
  }

...
abstract class RequestBuilderAction {
  ...
  static final class PartMap extends RequestBuilderAction {
    ...
    private final Annotation[] methodAnnotations;//comp490 Daniel Parker
    
    PartMap(Retrofit retrofit, String transferEncoding, Annotation[] paramAnnotations, Annotation[] methodAnnotations) {
    ...
    @Override void perform(RequestBuilder builder, Object value) {
      ...
      for (Map.Entry<?, ?> entry : map.entrySet()) {
        ...
        Converter<Object, RequestBody> converter =
            (Converter<Object, RequestBody>) retrofit.requestBodyConverter(entryClass, paramAnnotations, methodAnnotations);
        RequestBody body;
        try {
